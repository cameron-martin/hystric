...
def CTCEditDistance(beams=1):
    def ctc_edit_distance(y_true, y_pred):
        ...
        if beams == 1:
            ...
            decoded, log_probability = tf.nn.ctc_beam_search_decoder(tf.transpose(y_pred_shifted, (1, 0, 2)), sequence_length=sequence_length, beam_width=beams, top_paths=1)
        decoded = decoded[0]
    ...
    ctc_edit_distance.__name__ = f"ctc_edit_distance_{beams}_beams"
